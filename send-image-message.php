    ...
    if($type === "message"){
        switch( $event->message->type ){
            ...
            case "text":
                ...
                $original = "https://select2web.com/linebotcourse/baifern.jpg";
                $preview = "https://select2web.com/linebotcourse/baifern-preview.jpg"; 
                
                $imageMessageBuilder = new \LINE\LINEBot\MessageBuilder\ImageMessageBuilder($original, $preview);
